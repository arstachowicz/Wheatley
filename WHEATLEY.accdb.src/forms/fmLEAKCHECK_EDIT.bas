...
Begin Form
    ...
    RecSrcDt = Begin
        0x1b85ae90f43be540
    End
    Caption ="Edit Leak Check Information"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    BottomPadding =43
                    GridlineColor =10921638
                    ListItemsEditForm ="fmPARTNUM_NEW"
                    LeftMargin =44
                    TopMargin =29
                    RightMargin =44
                    BottomMargin =22
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=10) AND ((qryPARTNUM_ALL.subcategory)<>19)) OR ("
                        "((qryPARTNUM_ALL.partUseage)=10) AND ((qryPARTNUM_ALL.subcategory) Is Null)) ORD"
                        "ER BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=10) AND ((qryPARTNUM_ALL.subcategory)=19)) ORDER"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=10)) ORDER BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                    OnNotInList ="[Event Procedure]"
                    GroupTable =1
                    BottomPadding =43
                ...
                Begin ListBox
                    ...
                    Name ="List651"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblLEAK_CHECK.autoID, tblPARTNUM.partNum, refREV.rev FROM (tblLEAK_CHECK "
                        "LEFT JOIN tblPARTNUM ON tblLEAK_CHECK.partNum = tblPARTNUM.ID) LEFT JOIN refREV "
                        "ON tblLEAK_CHECK.rev = refREV.ID ORDER BY tblPARTNUM.partNum, refREV.rev; "
                    ColumnWidths ="0;3240;720"
                    AfterUpdate ="[Event Procedure]"
