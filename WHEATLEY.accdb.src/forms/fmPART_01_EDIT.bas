        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    Name ="List595"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblPART_01.autoID, tblPART_01.partNumber, refREV.rev FROM tblPART_01 LEFT"
                        " JOIN refREV ON tblPART_01.rev = refREV.ID ORDER BY tblPART_01.partNumber, refRE"
                        "V.rev; "
                    ColumnWidths ="0;2520;720"
