...
Begin Form
    ...
    RecSrcDt = Begin
        0x2ad7647cac45e540
    End
    Caption ="Edit Press Fixture Information"
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=15)) ORDER BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=16)) ORDER BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                    OnNotInList ="[Event Procedure]"
                    InputMask ="00\\-00\\-0000;0;_"
                    GroupTable =1
                ...
                Begin ListBox
                    ...
                    Name ="listPart"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblPRESS.ID, tblPARTNUM.partNum, refREV.rev FROM (tblPRESS LEFT JOIN refR"
                        "EV ON tblPRESS.rev = refREV.ID) LEFT JOIN tblPARTNUM ON tblPRESS.partNum = tblPA"
                        "RTNUM.ID ORDER BY tblPARTNUM.partNum, refREV.rev; "
                ...
                Begin ComboBox
                    ...
                    Name ="cmbMisc"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL ORDE"
                        "R BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                    InputMask ="00\\-00\\-0000;0;_"
                    GroupTable =1
                    GridlineColor =10921638
