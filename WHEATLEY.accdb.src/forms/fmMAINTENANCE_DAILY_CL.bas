        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Name ="Child133"
                    SourceObject ="Query.qryMAINTENANCE_DAILY_CL_DISPLAY"
                    GroupTable =1
                    RightPadding =180
                    GridlineColor =10921638
                    VerticalAnchor =1
                ...
                Begin Tab
                    ...
                    Begin
                        Begin Page
                            ...
                            Height =3585
                            BorderColor =10921638
                            Name ="Start of Every Shift"
                            EventProcPrefix ="Start_of_Every_Shift"
                            GridlineColor =10921638
                            ...
                            Begin
                                ...
                                Begin Label
                                    ...
                                    ForeColor =6052956
                                    Name ="Label524"
                                    Caption =" Remember to also conduct fume exhaust and specific gravity checks."
                                    GroupTable =6
                                    TopPadding =360
                                    GridlineColor =10921638
                                    LayoutCachedLeft =3255
                                ...
                                Begin ToggleButton
                                    ...
                                    ForeColor =2500134
                                    Name ="ckCable"
                                    Caption ="Electrical Cables Checked"
                                    FontName ="Calibri"
                                    OnMouseMove ="[Event Procedure]"
                                    OnClick ="[Event Procedure]"
                                    GroupTable =6
                        ...
                        Begin Page
                            ...
                            Height =3585
                            BorderColor =10921638
                            Name ="End of Every Shift"
                            EventProcPrefix ="End_of_Every_Shift"
                            GridlineColor =10921638
                            LayoutCachedLeft =2835
                            LayoutCachedTop =1755
                            LayoutCachedWidth =14685
                        ...
                        Begin Page
                            ...
                            Begin
                                ...
                                Begin ToggleButton
                                    ...
                                    Name ="ckDrain"
                                    DefaultValue ="False"
                                    Caption ="Were the tanks refilled and degassed?"
                                    FontName ="Calibri"
                                    OnMouseMove ="[Event Procedure]"
                                    OnClick ="[Event Procedure]"
                                    GroupTable =8
                                ...
                                Begin ToggleButton
                                    ...
                                    Name ="ckRefill"
                                    DefaultValue ="False"
                                    Caption ="Were the ultrasonic cleaners drained and cleaned?"
                                    FontName ="Calibri"
                                    OnMouseMove ="[Event Procedure]"
                                    OnClick ="[Event Procedure]"
                                    GroupTable =8
                                ...
                                Begin TextBox
                                    ...
                                    ForeColor =2500134
                                    Name ="txtMETER_CL"
                                    ValidationRule ="(IsNumeric([txtMETER_CL])=True) And (IsNull([txtMETER_CL])=False)"
                                    ValidationText ="Enter only numbers to CL water meter field."
                                    AfterUpdate ="[Event Procedure]"
                                    GroupTable =8
                                    GridlineColor =10921638
                                ...
                                Begin TextBox
                                    ...
                                    ForeColor =2500134
                                    Name ="txtMETER_CR"
                                    ValidationRule ="(IsNumeric([txtMETER_CR])=True) And (IsNull([txtMETER_CR])=False)"
                                    ValidationText ="Enter only numbers to CR water meter field."
                                    AfterUpdate ="[Event Procedure]"
                                    GroupTable =8
                                    GridlineColor =10921638
...
On Error GoTo Macro1_Err
    ...
    Else:
        ...
        If (ckIncomplete("ck*", Me, True, 1) = False) Then
            ...
            bUSr = ckRefill
            bCable = ckCable
            sOhm = sqlStr(txtRESISTANCE)
            sH2O_CL = sqlStr(txtMETER_CL)
            sH2O_CR = sqlStr(txtMETER_CR)
