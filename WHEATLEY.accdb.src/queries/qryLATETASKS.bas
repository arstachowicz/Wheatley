Operation =1
Option =0
Where ="(((tblSUPERVISORS.email)<>\"\") AND ((tblSUPERVISORS.Employed)=True))"
Begin InputTables
    Name ="tblTASKLIST"
    Name ="tblSUPERVISORS"
End
...
Begin
    ...
    End
    Begin
        dbText "Name" ="[QESubquery_20DBFDA67C464000B9C38AC7289E4BF5].[tblTASKLIST].[ID]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[QESubquery_20DBFDA67C464000B9C38AC7289E4BF5].[tblTASKLIST].[frequency]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[QESubquery_20DBFDA67C464000B9C38AC7289E4BF5].[tblTASKLIST].[taskTitle]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[QESubquery_20DBFDA67C464000B9C38AC7289E4BF5].[tblTASKLIST].[combined]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[QESubquery_20DBFDA67C464000B9C38AC7289E4BF5].[tblTASKLIST].[tableRel]"
        dbLong "AggregateType" ="-1"
    End
End
Begin
