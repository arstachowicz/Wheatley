        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    ColumnWidths ="0;1440"
                    StatusBarText ="The shift the employee works"
                    GroupTable =3
                    RightPadding =15
                    GridlineColor =10921638
...
Dim sPass As String
    ...
    If (ckIncomplete("txt*", Me, True, 2) = False) Then
        ...
        If InStr(sEm, Chr(64)) Then 'checks if they entered "@"
            If Right(sEm, 4) = ".com" Then
                sEm = """" & sEm & """"
            Else:
                MsgBox "Check the supervisor email address." 'error checking
                txtEMAIL.SetFocus
                Exit Sub
            End If
        ElseIf Right(sEm, Len(sDom)) <> sDom Then
            sEm = """" & sEm & sDom & """"
        End If
