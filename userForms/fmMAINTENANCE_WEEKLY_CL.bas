...
Begin Form
    ...
    RecSrcDt = Begin
        0x6356782e2e2fe540
    End
    RecordSource ="tblMAINTENANCE_WEEKLY_CL"
    Caption ="Weekly Maintenance - CL"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ToggleButton
                    ...
                    Name ="ckSink"
                    DefaultValue ="False"
                    Caption ="Eye Flush Sink Checked"
                    FontName ="Calibri"
                    OnMouseMove ="[Event Procedure]"
                    OnClick ="[Event Procedure]"
                    GroupTable =1
