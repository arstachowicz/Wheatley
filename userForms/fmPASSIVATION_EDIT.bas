...
Begin Form
    ...
    RecSrcDt = Begin
        0x1b85ae90f43be540
    End
    Caption ="Edit Passivation Information"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    Name ="List651"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblPASSIVATE.ID, tblPARTNUM.partNum, refREV.rev FROM (tblPASSIVATE LEFT J"
                        "OIN refREV ON tblPASSIVATE.rev = refREV.ID) LEFT JOIN tblPARTNUM ON tblPASSIVATE"
                        ".partNum = tblPARTNUM.ID ORDER BY tblPARTNUM.partNum, refREV.rev; "
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=9)) ORDER BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.subcategory)=7) AND ((qryPARTNUM_ALL.partUseage)=9)) ORDER B"
                        "Y qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                    OnNotInList ="[Event Procedure]"
                    GroupTable =1
                    GridlineColor =10921638
