        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    Name ="List317"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblEP.ID, tblPARTNUM.partNum, refREV.rev FROM (tblEP LEFT JOIN tblPARTNUM"
                        " ON tblEP.partNum = tblPARTNUM.ID) LEFT JOIN refREV ON tblEP.Rev = refREV.ID ORD"
                        "ER BY tblPARTNUM.partNum, refREV.rev; "
