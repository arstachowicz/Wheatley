...
Begin Form
    ...
    RecSrcDt = Begin
        0x1b85ae90f43be540
    End
    Caption ="New Leak Check Information"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.subcategory)=19)) OR (((qryPARTNUM_ALL.subcategory)=19)) ORD"
                ...
                Begin CommandButton
                    ...
                    ControlTipText ="Enter New Record"
                    TopPadding =180
                    GridlineColor =10921638
                    ImageData = Begin
