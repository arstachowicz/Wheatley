...
Private Sub cmdCHECK_Click()
    ...
    If rs!password <> txtPassword Then 'if the password is wrong
        ...
        rs.Close
        Exit Sub
    ElseIf IsNull(Trim(rs!password)) = True Then
        MsgBox "This account has not been set up yet. Contact another supervisor to establish a password."
    End If
