        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    Name ="List317"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblEP_BATHE.ID, tblPARTNUM.partNum, refREV.rev FROM (tblEP_BATHE INNER JO"
                        "IN tblPARTNUM ON tblEP_BATHE.partNum = tblPARTNUM.ID) LEFT JOIN refREV ON tblEP_"
                        "BATHE.rev = refREV.ID ORDER BY tblPARTNUM.partNum, refREV.rev; "
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT qryPARTNUM_ALL.uniqID, qryPARTNUM_ALL.partNumber FROM qryPARTNUM_ALL WHER"
                        "E (((qryPARTNUM_ALL.partUseage)=12)) ORDER BY qryPARTNUM_ALL.partNumber; "
                    ColumnWidths ="0;1440"
                    OnNotInList ="[Event Procedure]"
                    InputMask ="00\\-00\\-0000;0;_"
                    GroupTable =1
...
Private Sub cmbASSEM_NotInList(NewData As String, Response As Integer)
    Call notListed0107(NewData, Response, 12, 26)
End Sub

Private Sub cmbELEC1_NotInList(NewData As String, Response As Integer)
    Call notListed0107(NewData, Response, 12, 20)
End Sub
...
Private Sub cmbframe1_NotInList(NewData As String, Response As Integer)
    Call notListed0107(NewData, Response, 12, 22)
End Sub

Private Sub cmbframe2_NotInList(NewData As String, Response As Integer)
    Call notListed0107(NewData, Response, 12, 23)
End Sub
