Operation =1
Option =0
Where ="(((qryPARTNUM_ALL.linkedID)=uq!sID)) Or (((qryPARTNUM_ALL.partNumber)=\"07-12-01"
    "10\"))"
Begin InputTables
    Name ="qryPARTNUM_ALL"
...
Begin Joins
    ...
    Expression ="qryPARTNUM_ALL.subcategory = tblSUBCATEGORY.ID"
    Flag =2
End
Begin OrderBy
    Expression ="tblPARTNUM.partNum"
